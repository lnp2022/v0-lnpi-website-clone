...
const ko = {
  ...
  // 무선 스위치 하위 메뉴
  wirelessSwitchAllInOne: "올인원 일괄 소등 스위치", // 🌟 신제품 추가됨!
...
companyFeature1: "합리적인 가격",
companyFeature2: "1시간 이내의 빠른 설치",
companyFeature3: "먼지 걱정 없는 청결한 시공",
companyConcludingSentence: "주식회사 엘엔피는 혁신적인 솔루션을 통해 우물천장 무드등 시공을 누구나 부담 없이 선택할 수 있는 시대를 열었습니다. 오늘날 필수 요소로 자리 잡은 이 변화의 시작에는 엘엔피가 있습니다.",
}
...
companyFeature1: "Reasonable price",
companyFeature2: "Quick installation within 1 hour",
companyFeature3: "Clean construction without dust",
companyConcludingSentence: "LNP Corporation has opened an era where anyone can enjoy ceiling mood lighting without burden through innovative solutions. LNP is at the beginning of this change that has become an essential element today.",
}
...
companyFeature1: "ราคาที่เหมาะสม",
